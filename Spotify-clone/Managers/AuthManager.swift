...
final class AuthManager {
    ...
    struct Constants {
        ...
        static let redirectURI = "https://github.com/pipedev10"
    ...
    public var signInURL: URL? {
        ...
        let urlComplete = "\(base)?response_type=code&client_id=\(Constants.clientID)&scope=\(Constants.scopes)&redirect_uri=\(Constants.redirectURI)&show_dialog=TRUE"
